            ...
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$journee->id}}</td>
                        <td>{{$journee->nom}}</td>
                        <td>{{$journee->date_debut}}</td>
                        <td>{{$journee->date_fin}}</td>
                        <td>
                            <form class="inline-block" action="{{url()->current().'/'.$journee->id}}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                                <button class="btn" type="submit"><i class="pe-7s-close"></i>Supprimer</button>
                            </form>

                            <button class="btn" type="button" data-toggle="collapse" data-target="#{{'editChampCollapse'.$journee->id}}" aria-expanded="false" aria-controls="{{'editChampCollapse'.$journee->id}}">
                        ...
                        <div class="collapse" id="{{'editChampCollapse'.$journee->id}}">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Modifier le championnat</h4>
                                </div>
                                <div class="content">
                                    <form action="{{url()->current().'/'.$journee->id}}" method="POST">
                                        {{ csrf_field() }}
                                        {{ method_field('PUT') }}
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="nom :" name="nom_championnat" value="{{$journee->nom}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Date de début :</label>
                                                    <input type="date" name="date_debut" class="form-control" value="{{date_format(new DateTime($journee->date_debut), 'Y-m-d')}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Heure de début :</label>
                                                    <input type="time" name="time_debut" class="form-control" value="{{date_format(new DateTime($journee->date_debut), 'H:i')}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Date de fin :</label>
                                                    <input type="date" name="date_fin" class="form-control" value="{{date_format(new DateTime($journee->date_fin), 'Y-m-d')}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Heure de fin :</label>
                                                    <input type="time" name="time_fin" class="form-control" value="{{date_format(new DateTime($journee->date_fin), 'H:i')}}">
                                                </div>
                                            </div>
                                        </div>
